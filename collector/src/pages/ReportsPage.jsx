...
const ReportsPage = () => {
  ...
  }, [fetchAssignedCustomers, fetchAssignedCustomerDeposits, fetchAssignedCustomerWithdrawalRequests]); // Depend on fetch functions
  ...
  }, [assignedCustomers, deposits, withdrawalRequests]); // Depend on context data
  ...
  // Removed the check for !collector as the page relies on loading/error states
  // and the presence of data arrays from context.
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'relative', zIndex: 1 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
            ...
            <Box>
              ...
              {/* Removed collector name display as it's not available from context */}
            </Box>
          </Box>
